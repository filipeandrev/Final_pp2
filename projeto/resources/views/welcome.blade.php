...
<div class="container">
      ...
      <div class="jumbotron">
        ...
        <p><a class="btn btn-lg btn-success btn-dark" href="{{ route('register') }}" role="button">Cadastre-se!</a></p>
      </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-primary btn-dark" href="#" role="button">Mais detalhes &raquo;</a></p>
        </div>
        <div class="col-lg-4">
